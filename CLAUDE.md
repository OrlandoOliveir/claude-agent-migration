...
O projeto utiliza um framework interno chamado Maker que pode impedir diversos falsos positivos.

Portanto, seja conservador nas conclusões.

A maioria dos parâmetros que podem ser nulos, nunca serão, mas vale a pena pontuar.

Seja sucinto nos textos e mantenha as informações resumidas.
